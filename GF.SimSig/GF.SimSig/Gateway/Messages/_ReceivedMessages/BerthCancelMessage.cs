...
{
    public class BerthCancelMessage : BerthMessage, IReceivedMessage
    {
        /// <summary>
        /// Instantiates a new <see cref="BerthCancelMessage"/> object from the supplied <see cref="JObject"/>
        /// </summary>
        ...
        public BerthCancelMessage(JObject messageObject, MessageType messageType, [CallerMemberName] string? callingMethod = null) : base(messageObject, messageType, callingMethod) { }

        /// <summary>
        /// Instantiates a new <see cref="BerthCancelMessage"/>. Should only be used for testing
        /// </summary>
        ...
        internal BerthCancelMessage(string areaId, string from, string to, string description, string berthMessageType, TimeSpan time, [CallerMemberName] string? callingMethod = null) : base (areaId, from, to, description, berthMessageType, time, callingMethod) { }
    }
}
