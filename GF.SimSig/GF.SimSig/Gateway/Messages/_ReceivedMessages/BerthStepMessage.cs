...
{
    public class BerthStepMessage : BerthMessage, IReceivedMessage
    {
        /// <summary>
        /// Instantiates a new <see cref="BerthStepMessage"/> object from the supplied <see cref="JObject"/>
        /// </summary>
        ...
        public BerthStepMessage(JObject messageObject, MessageType messageType, [CallerMemberName] string? callingMethod = null) : base(messageObject, messageType, callingMethod) { }

        /// <summary>
        /// Instantiates a new <see cref="BerthStepMessage"/>. Should only be used for testing
        /// </summary>
        ...
        internal BerthStepMessage(string areaId, string from, string to, string description, string berthMessageType, TimeSpan time, [CallerMemberName] string? callingMethod = null) : base (areaId, from, to, description, berthMessageType, time, callingMethod) { }
    }
}
