...
namespace GF.SimSig.Gateway.Stomp.IO
{
    /// <summary>
    ...
    public class StompFrameWriterWithConfirmation : IStompFrameWriter
    {
        ...
        public StompFrameWriterWithConfirmation(IStompFrameWriter writer, IStompFrameObservable frameObservable, TimeSpan? retryInterval = null)
        {
            ...
            if (frameObservable == null)
                throw new ArgumentNullException(nameof(frameObservable));
        ...
        public async Task WriteAsync(Frame frame, CancellationToken cancellationToken)
        {
            ...
            {
                var receiptWaiter = new TaskCompletionSource<object>();
                var task = receiptWaiter.Task;
                ...
                if (task.IsFaulted) throw task.Exception ?? new Exception("An error has occurred executing the task");
        ...
        private void OnNext(Frame frame)
        {
            ...
            if(receiptId != null)
            {
                if (_receiptWaiters.TryGetValue(receiptId, out TaskCompletionSource<object>? tcs))
                {
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
                    tcs.TrySetResult(null);
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
                    _receiptWaiters.TryRemove(receiptId, out _);
                }
            }
        }
