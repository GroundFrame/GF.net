...
namespace GF.SimSig.Gateway.Stomp.IO
{
    ...
    public static class StompFrameWriterExtensions
    {
            ...
            CancellationToken? cancellationToken = null)
        {
            ...
            //GatewayStompMessageSerializer serializer = new GatewayStompMessageSerializer();
            //GatewayStompMessage connectMessage = new GatewayStompMessage("CONNECT");
            //connectMessage["accept-version"] = "1.1";
            //return writer.WriteAsync(System.Text.Encoding.ASCII.GetBytes(serializer.Serialize(connectMessage)), cancelToken);
        }
