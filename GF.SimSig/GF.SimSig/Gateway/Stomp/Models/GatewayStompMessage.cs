...
{
    public class GatewayStompMessage
    {
        ...
        public GatewayStompMessage(string command)
        ...
        public GatewayStompMessage(string command, string body)
        ...
        internal GatewayStompMessage(string command, string body, Dictionary<string, string> headers)
        {
            Command = command;
            Body = body;
            _headers = headers;
