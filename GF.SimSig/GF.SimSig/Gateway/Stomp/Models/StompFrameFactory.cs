...
using GF.SimSig.Gateway.Stomp.Models.Frames;

namespace GF.SimSig.Gateway.Stomp.Models
{
    /// <summary>
    ...
    public static class StompFrameFactory
    {
            ...
            IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
            ...
            {
                new KeyValuePair<string, string>(StompHeaders.AcceptVersion, acceptVersion),
                /*if (host != null)*/
                new KeyValuePair<string, string>(StompHeaders.Host, host)
            };
            ...
            IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
            ...
            var headers = new List<KeyValuePair<string, string>>(5)
            {
                new KeyValuePair<string, string>(StompHeaders.Destination, destination)
            };
            ...
            IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
            ...
            {
                new KeyValuePair<string, string>(StompHeaders.Destination, destination),
                new KeyValuePair<string, string>(StompHeaders.Id, id)
            };
            if (receipt != null) headers.Add(new KeyValuePair<string, string>(StompHeaders.Receipt, receipt));
        ...
        public static Frame CreateUnsubscribe(string id, string? receipt = null, IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
            ...
            IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
            ...
            var headers = new List<KeyValuePair<string, string>>(2)
            {
                new KeyValuePair<string, string>(StompHeaders.Transaction, transaction)
            };
            if (receipt != null) headers.Add(new KeyValuePair<string, string>(StompHeaders.Receipt, receipt));
        ...
        public static Frame CreateAbort(string transaction, string? receipt = null, IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
            if (transaction == null)
                throw new ArgumentNullException(nameof(transaction));
        ...
        public static Frame CreateDisconnect(string? receipt = null, IEnumerable<KeyValuePair<string, string>>? extraHeaders = null)
        {
