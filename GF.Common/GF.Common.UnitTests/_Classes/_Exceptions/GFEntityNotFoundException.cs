...
{
    public class GFEntityNotFoundException
    {
        /// <summary>
        /// Tests passing empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.GFEntityNotFoundException(string, string?)"/> constuctor throws an <see cref="ArgumentNullException"/>
        /// </summary>
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new Common.GFEntityNotFoundException(message));
        }

        /// <summary>
        /// Tests passing an empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.GFEntityNotFoundException(string, Exception, string?)"/> constuctor throws an <see cref="ArgumentNullException"/>
        /// </summary>
        /// <param name="message">The message argument</param>
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new Common.GFEntityNotFoundException(message, innerException));
        }

        /// <summary>
        /// Tests the <see cref="Common.GFEntityNotFoundException.GFEntityNotFoundException(string, string?)"/> constructor
        /// </summary>
        ...
        {
            Common.GFEntityNotFoundException testException = new(message);
            Assert.Equal(message, testException.Message);
            Assert.Null(testException.InnerException);
        }

        /// <summary>
        /// Tests the <see cref="Common.GFEntityNotFoundException.GFEntityNotFoundException(Exception, string, string?)"/> constructor
        /// </summary>
        /// <param name="message">The exception message</param>
        /// <param name="innerException">The inner exception</param>
        [Theory]
        ...
        {
            Common.GFEntityNotFoundException testException = new(message, innerException);
            Assert.Equal(message, testException.Message);
        ...
        /// <summary>
        /// Tests passing empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.Build(string, string, string?)"/> method throws an <see cref="ArgumentNullException"/>
        /// </summary>
        /// <param name="message">The message argument</param>
        [Theory]
        [InlineData(null, null)]
        ...
        {
            Assert.Throws<ArgumentNullException>(() => Common.GFEntityNotFoundException.Build(message, translationKey));
        }

        /// <summary>
        /// Tests passing empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.Build{T0}(string, string, T0, string?)"/> method throws an <see cref="ArgumentNullException"/>
        /// </summary>
        /// <param name="message">The message argument</param>
        ...
        {
            Assert.Throws<ArgumentNullException>(() => Common.GFEntityNotFoundException.Build(message, translationKey, arg0));
        }
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        {
            Assert.Throws<ArgumentNullException>(() => Common.GFEntityNotFoundException.Build(message, translationKey, arg0, arg1));
        }
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        /// <summary>
        /// Tests passing empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.Build(Exception, string, string, string?)"/> method throws an <see cref="ArgumentNullException"/>
        /// </summary>
        /// <param name="innerException">The inner exception</param>
        /// <param name="message">The message argument</param>
        /// <param name="translationKey">The translation key</param>
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        /// <summary>
        /// Tests passing empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.Build{T0}(Exception, string, string, T0, string?)"/> method throws an <see cref="ArgumentNullException"/>
        /// </summary>
        /// <param name="innerException">The inner exception</param>
        /// <param name="message">The message argument</param>
        /// <param name="translationKey">The translation key</param>
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        /// <summary>
        /// Tests passing empty string or null arguments to the <see cref="Common.GFEntityNotFoundException.Build{T0, T1}(Exception, string, string, T0, T1, string?)"/> method throws an <see cref="ArgumentNullException"/>
        /// </summary>
        /// <param name="innerException">The inner exception</param>
        /// <param name="message">The message argument</param>
        /// <param name="translationKey">The translation key</param>
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        /// <summary>
        /// Tests the <see cref="Common.GFEntityNotFoundException.Build(string, string, string?)"/> method
        /// </summary>
        ...
        {
            var testTranslation = Common.GFEntityNotFoundException.Build(message, translationKey);
            Assert.IsType<Common.GFEntityNotFoundException>(testTranslation);
        ...
        /// <summary>
        /// Tests the <see cref="Common.GFEntityNotFoundException.Build{T0}(string, string, T0, string?)"/> method
        /// </summary>
        /// <param name="message">The message</param>
        /// <param name="translationKey">The translation key</param>
        ...
        {
            var testTranslation = Common.GFEntityNotFoundException.Build(message, translationKey, arg0);
            Assert.IsType<Common.GFEntityNotFoundException>(testTranslation);
            Assert.Equal(message, testTranslation.Message);
            Assert.Equal(translationKey, testTranslation.MessageTranslationKey);
        ...
        /// <summary>
        /// Tests the <see cref="Common.GFEntityNotFoundException.Build{T0, T1}(string, string, T0, T1, string?)"/> method
        /// </summary>
        /// <param name="message">The message</param>
        /// <param name="translationKey">The translation key</param>
        /// <param name="arg0">The first placeholder</param>
        ...
        {
            var testTranslation = Common.GFEntityNotFoundException.Build(message, translationKey, arg0, arg1);
            Assert.IsType<Common.GFEntityNotFoundException>(testTranslation);
            Assert.Equal(message, testTranslation.Message);
            Assert.Equal(translationKey, testTranslation.MessageTranslationKey);
