...
namespace GF.Rails
{
    public abstract class TemporalBase<TId, THistory> where THistory : ITemporalHistory<TId>
    {
        ...
        /// <param name="id">The parent object id</param>
        /// <param name="name">The place name</param>
        public TemporalBase(TId id, string name) : this(id, id.ToString(), name) { }
        ...
        {
            return this._history.Any(h => h.Id.TemporalPeriod.Overlaps(new TemporalPeriod(startDate, endDate)));
        }
    }
}
