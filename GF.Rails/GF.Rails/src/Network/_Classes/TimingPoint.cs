...
namespace GF.Rails.Network
{
    ...
    public class TimingPoint : TemporalBase<TimingPointId, TimingPointHistory>, INode<TimingPointId, TimingPointNeighbourProperty>, ITimingPoint
    {
        ...
        public TimingPoint(string name, string key, float latitude, float longitude) : base (new TimingPointId(Guid.NewGuid()), name, key)
        {
        ...
        public TimingPoint(string name, string key, float latitude, float longitude, DateTime startDate, TimingPointType type, BRRegion region, Place place = null) : this(name, key, latitude, longitude)
        {
