...
namespace GF.Rails.Network
{
    public class SignalBlockHistory : ITemporalHistory<SignalBlockId>
    {
        ...
        public SignalBlockHistory(SignalBlockId signalBlockId, DateTime startDate, DateTime? endDate, Power power, byte ra, Speed averageSpeed, Gradient averageGradient, DirectionType gradientDirection, bool canControlTrain = false)
        {
