...
namespace GF.Rails.Network.SandT
{
    ...
    /// </summary>
    public class SignalBlock : TemporalBase<SignalBlockId, SignalBlockHistory>, INode<SignalBlockId, SignalBlockNeighbourProperty>, ITemporal<SignalBlockId, SignalBlockHistory>, ISignalBlock, ISignalBoxPanelOrWorkstationItem
    {
        #region Fields
        ...
        /// <summary>
        /// Instantiates a new <see cref="SignalBlock"/>
        /// </summary>
        ...
        /// <summary>
        /// Adds a new history item to this signal block.
        /// </summary>
        /// <param name="startDate">The start date of the history item</param>
        public void AddHistory(DateTime startDate, ISignalBoxPanelOrWorkstation signalBoxPanelOrWorkstation, Power power, byte ra, Speed averageSpeed, Gradient averageGradient, DirectionType gradientDirection, bool canControlTrain = false)
        {
            base.AddHistory(new SignalBlockHistory(this.Id, startDate, null, signalBoxPanelOrWorkstation, power, ra, averageSpeed, averageGradient, gradientDirection, canControlTrain));
        ...
        /// <summary>
        /// Determines whether 2 <see cref="ISignalBox"/> items match
        /// </summary>
        /// <param name="obj">The other object to compare</param>
        /// <returns>True if the items are equal otherwise false</returns>
        public override bool Equals(object obj)
        {
            if (obj == null || !(obj is SignalBlock))
            {
                return false;
            }

            return this.PanelItemId.Equals((obj as SignalBlock).PanelItemId);
        }
